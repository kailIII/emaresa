...
##############################################################################
{
	...
	'version': '3.13',
	'author': 'Novapoint Group LLC, Modified by: Opendrive Ltda.',
	'website': '[www.novapointgroup.com, www.opendrive.cl]',
	'depends': ['account_cancel', 'report_aeroo'],
	'data': [
		'security/npg_account_make_deposit_security.xml',
		'security/ir.model.access.csv',
		'report/npg_account_make_deposit_report.xml',
