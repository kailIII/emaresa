...
class Parser(report_sxw.rml_parse):
    ...
    _name = 'report.account.general.ledger.xls'
    ...
    def lines(self, account):
        ...
        sql = """
            ...
            p.name AS partner_name, p.vat as partner_vat ,j.name AS journal_name,  l.maturity AS line_maturity
            FROM account_move_line l
    ...
    def _sum_balance_account(self, account):
        print("------ ENTRA A BALANCE---")
        if account.type == 'view':
            print("------ ACCOUNT.TYPE == VIEW ---")
            print("BALANCE: " )
