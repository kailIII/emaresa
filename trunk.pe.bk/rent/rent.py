...
#			}
	...
	def on_duration_changed(self, cr, uid, ids, rent_begin, duration, duration_unity_id, context=None):
		...
		day_unity = self.pool.get('product.uom').search(cr, uid, [('name','=','Day')], limit=1, context=context)
		month_unity = self.pool.get('product.uom').search(cr, uid, [('name','=','Month')], limit=1, context=context)
		year_unity = self.pool.get('product.uom').search(cr, uid, [('name','=','Year')], limit=1, context=context)
